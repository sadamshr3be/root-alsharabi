...
echo "unexpected error occured choose right one to install or tryagain "
          ...
          echo
          echo "Root credits to @sadam_alsharabi"
          echo "Tool created by @termuxalsharabi "
          
          echo
          echo "contact me on :"
          echo "telegraam  : @sadam_alsharabi "
          echo "Instagram : @sadam_alsharabi "
          echo "Twitter   : @sadamalsharabi "
echo
echo
          echo "Youtube : Gamerlinks "
          echo "https://youtube.com/channel/UCGmfv3D0tcKvHp8Tolf6Yqw "
